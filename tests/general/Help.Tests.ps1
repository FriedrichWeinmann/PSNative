...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSNative\functions", "$global:testroot\..\PSNative\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\PSNative\functions"
    "$global:testroot\..\PSNative\internal\functions"
)
